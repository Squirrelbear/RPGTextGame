...
public class Player implements AttackableTarget {
    ...
    public Player(String playerName) {
        playerHealth = playerMana = playerMaxHealth = playerMaxMana = 100;
    ...
    public String toString() {
        return "Player Status: " + playerName + " has " + playerHealth + "/" + playerMaxHealth
                + " HP and " + playerMana + "/" + playerMaxMana + " Mana.";
    }
    ...
    private int chooseAttackNumber(Scanner scan) {
        ...
        do {
            ...
            // Verify the player has entered a number
            if (!scan.hasNextInt()) {
    ...
    private boolean isAttackValid(int choice) {
        // Verify the input is a valid number and the player has enough mana to use it.
    ...
    public void restoreMana() {
        ...
        System.out.println("You have been restored for " + healAmount + " Mana bringing your Mana to "
    ...
    private void updateMinimumSpellCost() {
